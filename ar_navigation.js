        ...
        success: function (response) {
            ...
            for (var i = 0; i < steps.length; i++) {
                ...
                if (i > 0) {
                    ...
                    <a-image name="${instruction}" src="./assets/${images[image]}" scale="5 5 5" id="step_${i}" position="0 0 -3"
                        look-at="#step_${i - 1}"></a-image>
                    <a-entity>
                    ...
                    $("#scene_container").append(
                        `<a-entity gps-entity-place="latitude:${steps[i].maneuver.location[1]};longitude:${steps[i].maneuver.location[0]}">
                    <a-image name="${instruction}" src="./assets/ar_start.png" scale="5 5 5" id="step_${i}" position="0 0 -3"
                        look-at="#step_${i+1}"></a-image>
                    <a-entity>
                        <a-text height='50' value="${instruction}(${distance}m)"></a-text>
                    </a-entity>
